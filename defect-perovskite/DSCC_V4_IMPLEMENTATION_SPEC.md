...
(`~/runs/dscc_src_bp`); the b3 duplicate of s2 (launched 03:52 by the queue runner from an
...
far shells are D13's diagnostic on s0–s3).* B′ LR-only 43.4 / 34.7 / 24.0 / 14.9 / 14.1 / 12.1 /
8.5 (> 12 Å per seed 8.1 / 8.6 / 10.0 / 8.9 / 8.5 / 7.5); B′ LR + U 43.9 / 34.5 / 23.7 / 15.3 / 14.5 /
12.3 / 9.3; Φ = 0 48.5 / 39.5 / 28.8 / 18.7 / 20.3 / 13.5 / 10.3; Route A LR-only 49.6 / 42.3 / 30.6 /
19.7; out-of-fold neutral floor 30.8 / 21.5 / 17.4 / 10.3 / 10.2 / 9.5 / 8.3. B′ takes 4–5 meV/Å
per component off every shell, cuts the 8–10 Å excess over the floor from 10.1 to 3.9 and reaches
the floor beyond 12 Å; the near field stays open (43 against 31, C10). Shape error after post-hoc
...
632 ms, median 8.59, p95 13.7 (16 frames); SCF median 4 iterations. **Fails the registered 2×
...
4–5 meV/Å per component off every shell from 0–2 Å to beyond 12 Å and most of the far-field gap to
the neutral floor, 7.0 [4.1] meV/Å on the full RMSE with every seed outside the Φ = 0 seed range.
