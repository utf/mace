...
from mace.modules.dscc.ewald import ewald_matrix, pair_gradient, reciprocal_matrix, reciprocal_pair_gradient
from mace.modules.dscc.kernels import KernelConfig, kernel_components, kernel_pair_gradients, gamma_lr, gamma_lr_pair_gradient
...
def test_reciprocal_matrix_equals_the_ewald_route_including_the_diagonal(width):
    ...
    e = ewald_matrix(pos, cell, 0.5 * width)                  # pair width sqrt(2 (2 (w/2)^2)) = w
